...
public class Jobs {
    ...
    private LocationType locationType; // ON_SITE, REMOTE, HYBRID
	...
	public Jobs(int jobId, String title, String description, String location, LocationType locationType,
			...
			String applicationInstructions, Date createdAt, Employer employer, boolean active) {
		super();
		this.jobId = jobId;
		this.title = title;
	...
	public String toString() {
		return "Jobs [jobId=" + jobId + ", title=" + title + ", description=" + description + ", location=" + location
				+ ", locationType=" + locationType + ", jobType=" + jobType + ", jobExperience=" + jobExperience
				+ ", qualifications=" + qualifications + ", skillsRequired=" + skillsRequired + ", salary=" + salary
				+ ", postedDate=" + postedDate + ", applicationDeadline=" + applicationDeadline + ", applicationEmail="
				+ applicationEmail + ", applicationInstructions=" + applicationInstructions + ", createdAt=" + createdAt
				+ ", employer=" + employer + ", active=" + active + "]";
	}
